...
namespace Business
{
    public partial class BusinessStartup
    {
        ...
        public void ConfigureDevelopmentServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IAnasayfaPhotoUrlRepository, AnasayfaPhotoUrlRepository>();
            services.AddTransient<IHizmetDetailRepository, HizmetDetailRepository>();
            services.AddTransient<IRandevuRepository, RandevuRepository>();
            services.AddTransient<IHizmetRepository, HizmetRepository>();
            services.AddTransient<IHekimDetailRepository, HekimDetailRepository>();
            services.AddTransient<IHekimRepository, HekimRepository>();
            services.AddTransient<IHakkimizdaRepository, HakkimizdaRepository>();
            services.AddTransient<IDurumRepository, DurumRepository>();
            services.AddTransient<IBlogDetailRepository, BlogDetailRepository>();
            services.AddTransient<IBlogRepository, BlogRepository>();
            services.AddTransient<IAnasayfaRepository, AnasayfaRepository>();
