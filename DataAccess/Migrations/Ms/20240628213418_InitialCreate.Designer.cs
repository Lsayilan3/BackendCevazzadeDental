...
namespace DataAccess.Migrations.Ms
{
    ...
    [Migration("20240628213418_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Concrete.Anasayfa", b =>
                {
            ...
            modelBuilder.Entity("Entities.Concrete.AnasayfaPhotoUrl", b =>
                {
                    b.Property<int>("AnasayfaPhotoUrlId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("AnasayfaPhotoUrlId");

                    b.ToTable("AnasayfaPhotoUrls");
                });
            ...
            modelBuilder.Entity("Entities.Concrete.BlogDetail", b =>
                {
            ...
            modelBuilder.Entity("Entities.Concrete.Durum", b =>
                {
                    ...
                    b.Property<string>("ParagrafOne")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ParagrafTwo")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Entities.Concrete.Hekim", b =>
                {
                    ...
                    b.Property<string>("SosyalFace")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SosyalMail")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SosyalTwitter")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Sosyalingstagram")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Entities.Concrete.HekimDetail", b =>
                {
                    b.Property<int>("HekimDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("HekimDetailId");

                    b.ToTable("HekimDetails");
                });

            modelBuilder.Entity("Entities.Concrete.Hizmet", b =>
                {
            ...
            modelBuilder.Entity("Entities.Concrete.HizmetDetail", b =>
                {
                    b.Property<int>("HizmetDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("PhotoService")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("HizmetDetailId");

                    b.ToTable("HizmetDetails");
                });
            ...
            modelBuilder.Entity("Entities.Concrete.Randevu", b =>
                {
                    ...
                    b.Property<int>("HizmetlerimizId")
                        .HasColumnType("int");
